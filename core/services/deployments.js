...
proto.formatPackage = function(packageVersion) {
  ...
  return {
    ...
    blobUrl: common.getBlobDownloadUrl(_.get(packageVersion, "packageInfo.blob_url"), _.get(packageVersion, "deploymentsVersions.app_version")),
    size: _.get(packageVersion, "packageInfo.size"),
    manifestBlobUrl: common.getBlobDownloadUrl(_.get(packageVersion, "packageInfo.manifest_blob_url"), _.get(packageVersion, "deploymentsVersions.app_version")),
